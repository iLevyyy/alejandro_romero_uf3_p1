...
Route::middleware('year')->group(function () {
    Route::group(['prefix' => 'filmout'], function () {
        ...
        Route::get('films/{year}', [FilmController::class, "listFilmsByYear"])->name('filmsByYear');
        Route::get('films/{genre}', [FilmController::class, "listFilmsByGenre"])->name('filmsByGenre');
    ...
    Route::group(['prefix' => 'actorout'], function () {
        ...
        Route::get('actors/{year?}', [ActorController::class, "listActorsByDecade"])->name('actorsByDecade');
